<div class="content-wrapper" style= "background: #d6433b; color: #fff;">
    <div class="content-header" style= "background: #ffffff; color: #000000;">
        <div class="container-fluid">
            <div class="row">
                <div class="col-sm-6">
                    <h1 class="mt-1">Chat Messenger</h1>
                </div>
                <div class="col-sm-6">
    ...
    <article> <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 202.24 202.24">
            <defs>
                <style>
                    .cls-1 {
                        fill: #fff;
        ...
        font-weight: 100;
        text-align: center;">We&rsquo;ll be back soon!</h1>
        <div>
